...
public class MatchesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            List<String> matchList = matchesDao.getMatches(urlParts[1]);
            // User Not Found
            ...
            MatchesSuccessResponse matchesSuccessResponse = new MatchesSuccessResponse(matchList);
            String responseJson = gson.toJson(matchesSuccessResponse);
